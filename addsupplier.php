...
<center><h4><i class="icon-plus-sign icon-large"></i> Add Manufacturer</h4></center>
<hr>
<div id="ac">
<span>Manufacturer Name : </span><input type="text" style="width:265px; height:30px;" name="name" required/><br>
