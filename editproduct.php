...
<span>Chemical Name : </span><input type="text" style="width:265px; height:30px;"  name="gen" value="<?php echo $row['chem_name']; ?>" /><br>
...
<select name="manufact" style="width:265px; height:30px; margin-left:-5px;" >
	<option><?php echo $row['manufact']; ?></option>
	<?php
	...
	?>
		<option><?php echo $rows['manufact_name']; ?></option>
	<?php
	}
	?>
</select><br>
